sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prototipoDeAltaFidelidad.controller.DetailPage2", {
		...
		_onGenericTilePress7: function(oEvent) {
		...
		_onGenericTilePress8: function(oEvent) {
		...
		_onGenericTilePress9: function(oEvent) {
					...
					if (sap.ui.Device.system.phone) {
						...
						if (oPage.getShowNavButton && !oPage.getShowNavButton()) {
							...
							oPage.attachNavButtonPress(function() {
								this.oRouter.navTo("Dialog1", {}, true);
							}.bind(this));
						}
					}
				}.bind(this)
